...
games = {}
games["Mario Kart 8 Deluxe"] = Game.create!(title: "Mario Kart 8 Deluxe", platform: platforms['Switch'])
games["Poochy & Yoshi's Woolly World"] = Game.create!(title: "Poochy & Yoshi's Woolly World", platform: platforms['3DS'])
games["Miitopia"] = Game.create!(title: "Miitopia", platform: platforms['3DS'])
games["Animal Crossing: Happy Home Designer"] = Game.create!(title: "Animal Crossing: Happy Home Designer", platform: platforms['3DS'])
games["Style Savvy: Fashion Forward"] = Game.create!(title: "Style Savvy: Fashion Forward", platform: platforms['3DS'])
games["Animal Crossing: New Leaf"] = Game.create!(title: "Animal Crossing: New Leaf", platform: platforms['3DS'])
games["Taiko Drum Master: Atsumete Tomodachi Daisakusen"] = Game.create!(title: "Taiko Drum Master: Atsumete Tomodachi Daisakusen", platform: platforms['Wii U'])
games["Animal Crossing: amiibo Festival"] = Game.create!(title: "Animal Crossing: amiibo Festival", platform: platforms['Wii U'])
games["Super Mario Maker"] = Game.create!(title: "Super Mario Maker", platform: platforms['Wii U'])
games["Goodbye! BOXBOY!"] = Game.create!(title: "Goodbye! BOXBOY!", platform: platforms['3DS'])
games["Chibi-Robo! Zip Lash"] = Game.create!(title: "Chibi-Robo! Zip Lash", platform: platforms['3DS'])
games["Fire Emblem Echoes: Shadows of Valentia"] = Game.create!(title: "Fire Emblem Echoes: Shadows of Valentia", platform: platforms['3DS'])
games["Kirby: Planet Robobot"] = Game.create!(title: "Kirby: Planet Robobot", platform: platforms['3DS'])
games["Picross 3D Round 2"] = Game.create!(title: "Picross 3D Round 2", platform: platforms['3DS'])
games["One Piece: Super Grand Battle! X"] = Game.create!(title: "One Piece: Super Grand Battle! X", platform: platforms['3DS'])
games["Super Smash Bros. for Nintendo 3DS"] = Game.create!(title: "Super Smash Bros. for Nintendo 3DS", platform: platforms['3DS'])
games["Yoshi's Woolly World"] = Game.create!(title: "Yoshi's Woolly World", platform: platforms['Wii U'])
games["Kirby and the Rainbow Curse"] = Game.create!(title: "Kirby and the Rainbow Curse", platform: platforms['Wii U'])
games["Super Smash Bros. for Wii U"] = Game.create!(title: "Super Smash Bros. for Wii U", platform: platforms['Wii U'])
games["Mario Kart 8"] = Game.create!(title: "Mario Kart 8", platform: platforms['Wii U'])
games["Monster Hunter Stories"] = Game.create!(title: "Monster Hunter Stories", platform: platforms['3DS'])
games["Shovel Knight"] = Game.create!(title: "Shovel Knight", platform: platforms['Wii U'])
games["Azure Striker Gunvolt 2"] = Game.create!(title: "Azure Striker Gunvolt 2", platform: platforms['3DS'])
games["Mario Party: Star Rush"] = Game.create!(title: "Mario Party: Star Rush", platform: platforms['3DS'])
games["Metroid Prime: Federation Force"] = Game.create!(title: "Metroid Prime: Federation Force", platform: platforms['3DS'])
games["Metroid Prime: Blast Ball"] = Game.create!(title: "Metroid Prime: Blast Ball", platform: platforms['3DS'])
games["Mini Mario & Friends amiibo Challenge"] = Game.create!(title: "Mini Mario & Friends amiibo Challenge", platform: platforms['Wii U'])
games["Mario & Luigi: Paper Jam"] = Game.create!(title: "Mario & Luigi: Paper Jam", platform: platforms['3DS'])
games["Ace Combat Assault Horizon Legacy +"] = Game.create!(title: "Ace Combat Assault Horizon Legacy +", platform: platforms['3DS'])
games["Mario Tennis: Ultra Smash"] = Game.create!(title: "Mario Tennis: Ultra Smash", platform: platforms['Wii U'])
games["Mario Party 10"] = Game.create!(title: "Mario Party 10", platform: platforms['Wii U'])
games["Splatoon"] = Game.create!(title: "Splatoon", platform: platforms['Wii U'])
games["niconico app"] = Game.create!(title: "niconico app", platform: platforms['3DS'])
games["Mario & Sonic at the Rio 2016 Olympic Games"] = Game.create!(title: "Mario & Sonic at the Rio 2016 Olympic Games", platform: platforms['Wii U'])
games["Captain Toad: Treasure Tracker"] = Game.create!(title: "Captain Toad: Treasure Tracker", platform: platforms['Wii U'])
games["The Legend of Zelda: Breath of the Wild"] = Game.create!(title: "The Legend of Zelda: Breath of the Wild", platform: platforms['Wii U'])
games["The Legend of Zelda: Twilight Princess HD"] = Game.create!(title: "The Legend of Zelda: Twilight Princess HD", platform: platforms['Wii U'])
games["Hyrule Warriors"] = Game.create!(title: "Hyrule Warriors", platform: platforms['Wii U'])
games["Hyrule Warriors Legends"] = Game.create!(title: "Hyrule Warriors Legends", platform: platforms['3DS'])
games["Star Fox Guard"] = Game.create!(title: "Star Fox Guard", platform: platforms['Wii U'])
games["Star Fox Zero"] = Game.create!(title: "Star Fox Zero", platform: platforms['Wii U'])
games["Fire Emblem Fates"] = Game.create!(title: "Fire Emblem Fates", platform: platforms['3DS'])
games["Code Name: S.T.E.A.M."] = Game.create!(title: "Code Name: S.T.E.A.M.", platform: platforms['3DS'])
games["Xenoblade Chronicles 3D"] = Game.create!(title: "Xenoblade Chronicles 3D", platform: platforms['3DS'])
games["Mega Man Legacy Collection"] = Game.create!(title: "Mega Man Legacy Collection", platform: platforms['3DS'])
games["Mario Sports Superstars"] = Game.create!(title: "Mario Sports Superstars", platform: platforms['3DS'])
games["Pokkén Tournament"] = Game.create!(title: "Pokkén Tournament", platform: platforms['Wii U'])
